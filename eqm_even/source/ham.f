...
!      enddo
      ...
      write(998,*)
      do i=1,ndimrt
        write(998,102)(d1(j,i),j=1,ndimt)
      enddo
      endif
...
!      enddo
     ...
     *,ndimr,0.d0,hami,ndimr)
      ...
      do i=1,ndimr
!      write(777,*)i,hami(i,i)
       do j=1,ndimr
          if (dabs(hami(i,j)-hami(j,i)).gt.0.02d-0) then
           write(*,*)'Non-sym AD'
           write(*,'(2i5,3f10.5)')i,j,hami(i,j),hami(j,i)
          endif   
