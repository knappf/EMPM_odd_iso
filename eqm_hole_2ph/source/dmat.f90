...
subroutine dmatrix(dim_phon,j_tot,dim_base,dim_baser,phonbs,lev,phon,ih_lev,ip_lev,hol_lev,par_lev,i_ph_int,nlev,ind_red,d_mat)
...
itz=-1
  ...
  do ii=1,dim_baser
     ...
     if (i_lam.ne.i_lam_old) then 
          call readro11('2f_rh.dat',i_lam,ronh1,dim_phon,1,nlev,1,nlev,isi_max)
          i_lam_old=i_lam
     endif 
...
!*************************************************************************
subroutine amatrix(dim_phon,j_tot,dim_base,dim_baser,phonbs,lev,phon,ih_lev,ip_lev,hol_lev,par_lev,i_ph_int,nlev,ind_red,a_mat)
implicit none
...
type(phon_typ), dimension (:), allocatable :: phon
type(phonbase_typ), dimension (:), allocatable :: phonbs
type(ro_typ), dimension(:), allocatable :: ronp,ronh
...
!  do i=1,dim_base
     ...
     if (i_lam.ne.i_lam_old) then
        call readro('2f_rp.dat',i_lam,ronp,nronp)
!        call readro('1f_rpp.dat',i_lam,ropp,nropp)
        call readro('2f_rh.dat',i_lam,ronh,nronh)
