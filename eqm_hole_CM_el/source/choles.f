...
c     last modification 13.5.2010
      ...
      subroutine cholesk(ndim,no,noo,dd,nx,mxt,D1)
      ...
      integer, dimension(:), allocatable :: nx,mxt,nxt
...
!      enddo
      ...
      open(6,file='mxt.dat',status='unknown',form='formatted')
      ...
      open(6,file='nxt.dat',status='unknown',form='formatted')
      write(6,*)ndim,no
      ...
      open(6,file='nx.dat',status='unknown',form='formatted')
      write(6,*)ndim,no
      do i=1,ndim
       write(6,*)nx(i)
      enddo
