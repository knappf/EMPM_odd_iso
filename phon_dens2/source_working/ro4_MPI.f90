...
!      do isi=0,isimax 
       ...
       rog(ibbb,ila,isi)=rog(ibbb,ila,isi)+fact*cc(1,i)%am*xx(ibbb,il1,il)*csixj(isi,jilap,jila,jil1,ja,jb)
...
!       endif
       ...
       rog(ibbb,il1,isi)=rog(ibbb,il1,isi)+fact*cc(1,i)%am*xx(ibbb,il,ila)*csixj(isi,jilap,jil1,jila,ja,jb)
...
!            do isi=isi_mn,isi_mx
            ...
            if (dabs(rog(ibbb,ila,isi)).gt.1.d-9) then 
