...
!*     last update 10.2.2015
      ...
      subroutine vinth(ipart,ifmx,isimax,lev,xthrun_min,xthrun_max)
      ...
      integer, dimension(:), allocatable :: jphon,ironp,iropp,ironh,iroph,ndcamn,ndcamp,ius
      ...
      open (3,file='0hom_phon.dat',status='old',form='formatted')
...
!       if (ee.le.xthrun) ius(i)=1
      ...
      open (3,file='1hom_phon.dat',status='old',form='formatted')
...
!       if (ee.le.xthrun) ius(i)=1
      ...
      open (3,file='2hom_phon.dat',status='old',form='formatted')
...
!      if (ee.le.xthrun) ius(i)=1
      ...
      open (3,file='3hom_phon.dat',status='old',form='formatted')
...
!       ius(i)=1
      ...
      open (3,file='4hom_phon.dat',status='old',form='formatted')
...
!*************************************************************************
      subroutine vintp(ipart,ifmx,isimax,lev,xthrun_min,xthrun_max)
